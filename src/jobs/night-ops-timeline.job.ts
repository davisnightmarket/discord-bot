...
export const NightTimelineJob =
    (client: Client, coreDataService: CoreDataService) => async () => {
        // get the guild
        ...
        for (const guild of guildList) {
            ...
            const { nightDataService, markdownService } =
                await GetGuildServices(guild.id, coreDataService);
            ...
            const nightTimelineList =
                await nightDataService.getNightTimelineList();
