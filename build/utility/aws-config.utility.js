...
async function GetAwsSecretsConfig() {
    ...
    if ((0, env_utility_1.GetEnv)() !== 'dev') {
        return {
            ...
            rdbConfig: await (0, aws_secrets_utility_1.GetAwsSecret)(RDB_KEYS_NAME)
        };
    }
    else {
        return {
            ...
            pgConfig: JSON.parse((0, fs_1.readFileSync)((0, path_1.join)(__dirname, `../../${PG_KEYS_NAME}.secret.json`), 'utf-8')),
            rdbConfig: JSON.parse((0, fs_1.readFileSync)((0, path_1.join)(__dirname, `../../${RDB_KEYS_NAME}.secret.json`), 'utf-8'))
        };
    }
}
