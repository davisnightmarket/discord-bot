...
exports.GetInstanceServicesByGuildId = exports.GetConfigInstanceByGuildId = void 0;
...
const InstanceConfigMapGet = new service_1.GoogleSpreadsheetsService(config_1.EnvConfig[Env].GSPREAD_CORE_CONFIG_ID)
...
const GetConfigInstanceByGuildId = (guildId) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const instanceConfigList = Object.values(yield InstanceConfigMapGet);
