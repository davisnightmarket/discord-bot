...
(async () => {
    try {
        ...
        console.log(`Started refreshing ${commands_1.default.length} application (/) commands.`);
        ...
        for (const guildId of guildIdList) {
            await rest.put(discord_js_1.Routes.applicationGuildCommands(appToken, guildId), {
                body
            });
