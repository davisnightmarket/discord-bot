...
exports.FoodCountMessageEvent = void 0;
const food_count_delete_button_event_1 = require("./food-count-delete-button.event");
 ...
 *
 */
const FoodCountMessageEvent = async (interaction) => {
    debug('OK');
    ...
    if (idName === 'food-count-cancel') {
        ...
        const cache = food_count_delete_button_event_1.FoodCountInputCache.get(idCache);
        if (cache == null) {
        ...
        m?.fetch(cache.messageInputId).then(async (msg) => {
            food_count_delete_button_event_1.FoodCountInputCache.update(idCache, {
                messageInputId: ''
            });
            try {
                await msg.delete();
        ...
        // delete the cache
        food_count_delete_button_event_1.FoodCountInputCache.delete(idCache);
    }
};
